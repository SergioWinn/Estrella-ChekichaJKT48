...
export function MoonIcon({ className = "size-4" }: IconProps) {
	return (
		<svg aria-hidden="true" className={className} fill="none" viewBox="0 0 24 24">
			<path d="M19 14.79A7.5 7.5 0 0 1 9.21 5a8.25 8.25 0 1 0 9.79 9.79Z" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.8" />
		</svg>
	);
}
...
export function AuthIcon({ className = "size-4" }: IconProps) {
	return (
		<svg aria-hidden="true" className={className} fill="none" viewBox="0 0 24 24">
			<path d="M10.75 4.75h-3A2.75 2.75 0 0 0 5 7.5v9a2.75 2.75 0 0 0 2.75 2.75h3" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
			<path d="M13 8.25 17.75 12 13 15.75" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
			<path d="M10 12h7.75" stroke="currentColor" strokeLinecap="round" strokeWidth="1.8" />
		</svg>
	);
}
...
export function LogoutIcon({ className = "size-4" }: IconProps) {
	return (
		<svg aria-hidden="true" className={className} fill="none" viewBox="0 0 24 24">
			<path d="M13.25 4.75h3A2.75 2.75 0 0 1 19 7.5v9a2.75 2.75 0 0 1-2.75 2.75h-3" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
			<path d="M11 8.25 6.25 12 11 15.75" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
			<path d="M13.75 12H6" stroke="currentColor" strokeLinecap="round" strokeWidth="1.8" />
		</svg>
	);
}
...
export function CloseIcon({ className = "size-4" }: IconProps) {
	return (
		<svg aria-hidden="true" className={className} fill="none" viewBox="0 0 24 24">
			<path d="M6.75 6.75 17.25 17.25" stroke="currentColor" strokeLinecap="round" strokeWidth="1.8" />
			<path d="M17.25 6.75 6.75 17.25" stroke="currentColor" strokeLinecap="round" strokeWidth="1.8" />
		</svg>
	);
}
